REPLIES = {
    ...
    'svc_dine_in': 'రెస్టారెంట్లో తినడం',
    ...
    'service_selected_dine_in': 'బాగుంది! మీరు రెస్టారెంట్లో తినడం ఎంచుకున్నారు.',
    ...
    'svc_card_dine_in_now_title': '🍽️ రెస్టారెంట్లో తినడం ఇప్పుడు',
    ...
    'svc_dine_in_now': 'రెస్టారెంట్లో తినడం ఇప్పుడు',
