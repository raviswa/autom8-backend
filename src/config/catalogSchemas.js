...
const LOB_SCHEMAS = {
  restaurant: {
    ...
    columnHelp: [
      ...
      ['kitchen_station - cooked: tawa, steamer, kadai, beverages, assembly, cold; readymade Sweets & Savories: sweets_counter (→ packing screen). Blank + category Sweets/Savories/readymade also defaults to sweets_counter. Do not use savory/readymade as station names — use sweets_counter.'],
